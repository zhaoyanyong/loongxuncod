...
<div style="position: absolute; top: 1.6%; left: 3%; width: 350px;">
      ...
      <div style="position: absolute; top: 7%; left: 1%; width: 30px;"><img src="images/right-dangqian.png" width="20" height="20"></div>
        ...
        <div style="position: absolute; top: 6.5%; left: 93%; width: 200px; color:#FFF;">
         <c:if test="${loginUserAtLine==1 }">
           <div style="float:left; margin-top:3%; margin-left:5%""><img src="images/right-bianji.png" width="13" height="13">
          
           <a href="showright_attributeinfo_addEnterAttribute?enterpriseId=${enterpriseId }"  ><span style="color:#fff;">添加</span></a>
        ...
        <div style="width:100%; height:450px; position:absolute; top:12%; left:0.4%;">
            ...
            <!-- table内嵌样式 -->
       		<table cellpadding="0" cellspacing="0" width="100%">
                ...
                <c:forEach items="${abs }" var="lb"   varStatus="s">
                <tr>
                    <td>${s.count }</td>
                    <td>${lb.year}</td>
                    ...
                    <a href="infoAttribute_Attribute?attributeId=${lb.attributeId }">查看 </a>
                    <c:if test="${loginUserAtLine!=3 }">
                  <a href="updateAttribute_Attribute?attributeId=${lb.attributeId }">修改 </a>
                  <c:if test="${loginUserAtLine==2 }">
                  <a href="delAttribute_Attribute?attributeId=${lb.attributeId }">删除 </a>
                 </c:if>
                   <c:if test="${loginUserAtLine==1}">
                       <a href="AnalysisAttribute?attributeId=${lb.attributeId }&enterpriseId=${lb.enterpriseId}">分析指标数据</a>
                     </c:if>
                 </c:if>
                    </td>
                </tr>
