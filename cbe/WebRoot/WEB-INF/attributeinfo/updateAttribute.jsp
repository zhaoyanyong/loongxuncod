...
a {
	...
	<body onload="radioSelect()">
         ...
         <form action="completeUpdateAttribute_Attribute" method="post"  name="saveAttri">  
							...
							<table cellpadding="0" cellspacing="0" width="100%" align="left">	
								<tr style="font-size:12px;">
									...
									<td width="82%" align="left" colspan="2">
										<input type="radio" class="radio" name="attribute.industryRatingNo" value="20"  />电子信息 <input type="radio" class="radio" name="attribute.industryRatingNo" value="21" />光电一体化
...
value="attribute.shareholdingRatioFive"/>"
								...
								<tr align="center" class="trBg">
									<td colspan="2">
										&nbsp;95.重要信息披露
										<input type="hidden" name="attribute.attributeId" value="${attribute.attributeId }"  type="text"/>
										<input type="hidden" name="attribute.enterpriseId" value="${attribute.enterpriseId }" type="text"/>
									</td>
									<td colspan="4">
										&nbsp;
