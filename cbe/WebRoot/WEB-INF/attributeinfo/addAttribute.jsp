...
a {
    ...
    <div style="position:absolute; top:2%; left:2%; width:10px;"><img src="images/right-bai.jpg" height="8" width="8"></div>
      ...
      <div style="position:absolute; top:1.6%; left:3%; width:320px;">	当前登录的用户：<span style="font-weight: bold;font-size: 18px;">${admin.aname }</span>&nbsp;&nbsp;&nbsp;&nbsp;用户角色：<span style="font-weight: bold;font-size: 16px;">${admin.roleName }</span></div>
        
        <div style="position: absolute; top: 2%; left: 85.5%; width: 10px;"><img src="images/right-sanjiao.png" width="8" height="8"></div>
        
        <div style="position: absolute; top: 1.6%; left: 87%; width: 30px;">IP:${admin.ip }</div>
	<br/>
	<div style="position: absolute; top: 6.5%; left: 85%; width: 200px; color:#FFF;">
        	<font color="red">只适用于企业用户录入信息</font>
            </div>
    ...
    <div style="position:absolute; top:2%; left:2%; width:10px;"><img src="images/right-bai.jpg" height="8" width="8"></div>
      ...
      <div style="position:absolute; top:1.6%; left:3%; width:320px;">当前登录的用户：${admin.aname }&nbsp;用户角色：${admin.roleName }</div>
      ...
      <div style="position: absolute; top: 7%; left: 1%; width: 30px;"><img src="images/right-dangqian.png" width="20" height="20"></div>
        ...
        <div style="position: absolute; top: 6.5%; left: 85%; width: 200px; color:#FFF;">
            ...
            <div style="float:left; margin-top:3%; margin-left:5%""><a href="javascript:saveAttri()"><img src="images/right-bianji.png" width="13" height="13" /></a></div>
