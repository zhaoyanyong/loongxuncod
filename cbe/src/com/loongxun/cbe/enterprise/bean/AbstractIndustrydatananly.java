...
/**
 * AbstractIndustrydatananly entity provides the base persistence definition of
 * the Industrydatananly entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractIndustrydatananly implements java.io.Serializable {
	 ...
	 */
	private static final long serialVersionUID = -9183264184826719623L;
	private Integer id;
	private Integer industryRatingNo;// 行业编号
	private Integer lifeCycle;// 生命周期:1初创期 2发展期 3稳定期
	...
	/** default constructor */
	public AbstractIndustrydatananly() {
	}

	/** minimal constructor */
	public AbstractIndustrydatananly(Integer industryRatingNo,
			Integer lifeCycle, Double allTotalScores) {
	...
	/** full constructor */
	public AbstractIndustrydatananly(Integer industryRatingNo,
			Integer lifeCycle, Double netAssetTarget, Double netAssetValue,
			Double fixAssetTarget, Double fixAssetValue, Double incomeTarget,
			Double incomeValue, Double profitTarget, Double profitValue,
			Double netbalTarget, Double netbalValue,
